...
Galleria.Picasa.prototype = {
    ...
    */
    ...
    /**
        ...
        @param {String} authkey The album Authentication Key
        @param {Function} [callback] The callback to be called when the data is ready

        @returns Instance
    */

    user: function( username, params, callback ) {
        if (typeof params === 'function') {
            callback = params;
            params = {};
        }

        return this._call( 'user', 'user/' + username, params, callback );
    },
    ...
    */
    ...
    useralbum: function( username, album, params, callback ) {
        if (typeof params === 'function') {
            callback = params;
            params = {};
        }

        return this._call( 'useralbum', 'user/' + username + '/album/' + album, params, callback );
    },
