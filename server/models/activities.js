// Activity Checks
this.checkCreateActivity = function(userId, options) {
  if (! userId)
...
this.checkUpdateActivity = function(userId, activityId, fields) {
...
this.trackCreateActivity = function(properties) {
  // TODO: do some server side logging here!
};

this.trackUpdateActivity = function(properties) {
  // TODO: do some server side logging here!
};

this.notifyActivityEvent = function(userId, activity, action) {
